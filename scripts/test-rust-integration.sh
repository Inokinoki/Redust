...
# Rust Integration Test Runner for Redust
# This runs the actual Rust Redis integration tests

set -e

echo "🦀 Rust Redis Integration Tests"
echo "================================="
...
run_rust_tests() {
    ...
    if [ $test_exit_code -eq 0 ]; then
        echo -e "${GREEN}✅ All Rust integration tests passed!${NC}"
    else
